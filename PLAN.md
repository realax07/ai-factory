...
| r2-dev-2.4 | dev | R2 задача 2.4: автодополнение тегов + priority-lock (worktree, ветка ...-4) | запущено 2026-09-22 deleg_dd8a510e | — |
| r2-dev-2.5 | dev | R2 задача 2.5: V3 «Бумага» на всю доску (Д-5), крестик, приоритеты цвет+SVG (ветка ...-5) | запущено 2026-09-22 deleg_dd8a510e | — |
