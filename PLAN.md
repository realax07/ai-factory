...
| r2-dev-2.2 | dev | R2 задача 2.2: страница /settings + сайдбар (ветка ...-2) | запущено 2026-09-22 deleg_53be1615 | — |
| r2-dev-2.3 | dev | R2 задача 2.3: селект категории в форме/фильтре + подсветка 422 (ветка ...-3) | запущено 2026-09-22 deleg_53be1615 | — |
| r2-designer | ui_designer | Д-5: 2-3 варианта стиля формы, design/ (новая роль, промпт ui_designer_agent.md) | запущено 2026-09-22 deleg_53be1615 | — |
